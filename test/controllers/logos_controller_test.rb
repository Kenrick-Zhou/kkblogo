...
class LogosControllerTest < ActionController::TestCase
  ...
  test "should create logo" do
    assert_difference('Logo.count') do
      post :create, logo: { jpg_url: @logo.jpg_url, name: @logo.name, png_url: @logo.png_url, svg_url: @logo.svg_url }
    end
  ...
  test "should update logo" do
    patch :update, id: @logo, logo: { jpg_url: @logo.jpg_url, name: @logo.name, png_url: @logo.png_url, svg_url: @logo.svg_url }
    assert_redirected_to logo_path(assigns(:logo))
  end
